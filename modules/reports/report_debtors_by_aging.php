...
$cols=Array(Array("label"=>"name","type"=>"string"),Array("label"=>$LANG['dept_aging'],"type"=>"number"),Array("label"=>$LANG['dept_summary'],"type"=>"number"),Array("label"=>$LANG['dept_payed'],"type"=>"number"));
$rows=Array(Array("customer","string",false),Array("age","int",false),Array("inv_total","int",true),Array("inv_paid","int",true));
