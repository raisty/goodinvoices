...
$smarty -> assign('active_tab', '#home');
	...
	echo "
		...
		<b>".$LANG["startdate"]."</b>&nbsp;<input type='text' class='date-picker' name='startdate' id='date1' value='".$startdate."' /><br /><br />
		<b>".$LANG["enddate"]."</b>&nbsp;<input type='text' class='date-picker' name='enddate' id='date2' value='".$enddate."' /><br /><br />
		<input type='submit' value='".$LANG["show"]."'>
		</form>
";

	echo "<br /><b>".$LANG["inv_created"]."</b><br />";
	foreach($sqls as $sql) {
	...
	echo "<br /><b>".$LANG["inv_modified"]."</b><br />";		
	foreach($sqls as $sql) {
	...
	echo "<br /><b>".$LANG["inv_payproc"]."</b><br />";
	global $db_server;
	foreach($sqls as $sql) {
		if ($db_server == 'pgsql') {
