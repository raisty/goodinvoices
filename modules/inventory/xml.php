...
$count = $sth_count_rows;
	...
	foreach ($inventory_all as $row) {
		...
		<a class='index_table' title='$LANG[delete] ".$row['name']."' href='index.php?module=inventory&view=edit&id=$row[id]'><img src='images/common/cross.png' height='16' border='-5px' padding='-4px' valign='bottom' /></a>
    ]]></cell>";
