...
else if ($_GET['submit'] == "numbering") {

	$array = array(0 => $LANG['numbering_0'], 1=>$LANG['numbering_1']);
	$default = "numbering";
	$description = $LANG['numbering'];
	$value = dropDown($array, $defaults[$default]);
}
else if ($_GET['submit'] == "suppliers_numbering") {

	$array = array(0 => $LANG['suppliers_numbering_0'], 1=>$LANG['suppliers_numbering_1']);
	$default = "suppliers_numbering";
	$description = $LANG['suppliers_numbering'];
	$value = dropDown($array, $defaults[$default]);
}
else {
