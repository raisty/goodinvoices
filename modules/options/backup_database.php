...
<tr><td align=\"center\"><br /><a href='index.php?module=options&amp;view=backup_database&amp;op=backup_db'><img src=\"./images/common/database_save.png\" alt=\"\" /><font color=\"red\">".$LANG['backup_database_now']."</font></a><br /><br /><br /></td></tr>
<tr><td>".$LANG['note'].": ".$LANG['backup_note_to_file']."</td></tr>
<tr>
<td>
<a class=\"cluetip\" href=\"#\"	rel=\"index.php?module=documentation&amp;view=view&amp;page=help_backup_database\" title=\"".$LANG['database_backup']."\"><img src=\"./images/common/help-small.png\" alt=\"\" /> <font color=\"green\"> ".$LANG['more_info']."</font></a>
</td>
</tr></table>
