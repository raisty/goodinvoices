...
<script type="text/javascript">
    ...
    var dataSourceUrl = 'https://docs.google.com/spreadsheet/ccc?key={/literal}{$Gdocskey}{literal}';
    var query, options, container;

    function init() {
      query = new google.visualization.Query(dataSourceUrl);
      container = document.getElementById("table");
      options = {'pageSize': {/literal}{$Gdocslimit}{literal}};
      sendAndDraw();
    }
...
{/literal}
<div style="text-align: right; margin-bottom: 20px;"><a href="https://docs.google.com/spreadsheet/ccc?key={$Gdocskey}" target="_blank"><img src="images/common/page_white_excel.png" alt="Spredsheet" /></a></div>
<div id="table"></div>

{else}Error: Calendar key issn't selected! Please edit extensions configuration file.<br />See extension folder: extensions/depot/modules/reports/report_depot.php{/if}