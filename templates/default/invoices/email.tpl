...
<div id="top"><h3>{$LANG.email}: {$invoice.index_name|htmlsafe}{$LANG.inv_tocust}</h3></div>
...
<table align="center">
	...
	<td><input type="text" name="email_subject" size="50" value="{$invoice.index_name|htmlsafe}" /></td>
	</tr>
	<tr>
		<td class="details_screen">{$LANG.message}</td>
		<td><textarea name="email_notes" class="editor" rows="8" cols="50">{$biller.name|htmlsafe}{$LANG.inv_em1}{$invoice.index_name|htmlsafe}{$LANG.inv_em2}</textarea></td>
	</tr>
</table>
...
<br />
	<table class="buttons" align="center">
	    <tr>
	        <td>
	            <button type="submit" class="invoice_save positive" name="submit">
	                <img class="button_img" src="./images/common/tick.png" alt="Ok" /> 
	                {$LANG.send_to_mail}
	            </button>
	            <button type="reset" value="Reset">
	                <img class="button_img" src="./images/common/cross.png" alt="Clear" /> 
	                {$LANG.reset}
	            </button>
