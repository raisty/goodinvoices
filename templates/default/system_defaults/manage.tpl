<br />
	...
	<tr>
		...
		<a class="cluetip" href="#"	rel="index.php?module=documentation&amp;view=view&amp;page=help_default_invoice_template_text"><img src="./images/common/help-small.png" alt="" /></a>
	...
	<tr>
		...
		<a href='index.php?module=system_defaults&amp;view=edit&amp;submit=delete'><img src="images/common/edit.png" title="{$LANG.edit}" alt="{$LANG.edit}" /></a></td><td class="details_screen">{$LANG.inv_delete}
		<a class="cluetip" href="#"	rel="index.php?module=documentation&amp;view=view&amp;page=help_delete"><img src="./images/common/help-small.png" alt="" /></a>
		</td>
	...
	<tr>
		...
		<a class="cluetip" href="#"	rel="index.php?module=documentation&amp;view=view&amp;page=help_logging"><img src="./images/common/help-small.png" alt="" /></a>
		</td>
	...
	<tr>
		<td class="details_screen"><a href='index.php?module=system_defaults&amp;view=edit&amp;submit=numbering'><img src="images/common/edit.png" title="{$LANG.edit}" alt="{$LANG.edit}" /></a></td><td class="details_screen">{$LANG.invoice_numbering} 
		<a class="cluetip" href="#"	rel="index.php?module=documentation&amp;view=view&amp;page=help_numbering"><img src="./images/common/help-small.png" alt="" /></a>
    </td>
		<td>{$defaultNumbering|htmlsafe}</td>
	</tr>
	<tr>
		<td class="details_screen"><a href='index.php?module=system_defaults&amp;view=edit&amp;submit=suppliers_numbering'><img src="images/common/edit.png" title="{$LANG.edit}" alt="{$LANG.edit}" /></a></td><td class="details_screen">{$LANG.suppliers_numbering} 
    </td>
		<td>{$defaultSuppNumbering|htmlsafe}</td>
	</tr>
        </table>
       <br /> 
