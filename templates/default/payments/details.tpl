...
<table align="center">
	...
	<tr>
		<td class='details_screen'>{$LANG.invoice_id}</td><td><a href='index.php?module=invoices&amp;view=quick_view&amp;id={$payment.ac_inv_id|htmlsafe}&amp;action=view'>{$invoice.index_id|htmlsafe}</a></td>
	</tr>
	<tr>
