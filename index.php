...
/* MOBILE DEVICE CHECK */
$mpath="include/class";
if(file_exists($mpath."/Mobile_Detect.php")) {
  include_once($mpath."/Mobile_Detect.php");
  $detect = new Mobile_Detect();

  if($detect->isMobile()) {
    if(is_dir("../templates/mobile")) {
      $design = "mobile";
    } else {
      $design = "default";
    }
  } elseif($detect->isTablet()) {
    if(is_dir("../templates/tablet")) {
      $design = "tablet";
    } elseif(is_dir("../templates/mobile")) {
      $design = "mobile";
    } else {
      $design = "default";
    }
...
if( !in_array($module."_".$view, $early_exit) )
{
		...
		foreach($config->extension as $extension)
		{
			...
			*/	
			if($extension->enabled == "1")
			{
				if(file_exists("./extensions/$extension->name/templates/$design/header.tpl")) 
				{
					$smarty -> $smarty_output("../extensions/$extension->name/templates/$design/header.tpl");
		...
		*/
		...
		{
			$smarty -> $smarty_output("../templates/$design/header.tpl");
		}
	...
	{	
		...
		foreach($config->extension as $extension)
		{
			...
			*/	
			if($extension->enabled == "1")
			{
				if(file_exists("./extensions/$extension->name/templates/$design/menu.tpl")) 
				{
					$smarty -> $smarty_output("../extensions/$extension->name/templates/$design/menu.tpl");
					$extensionMenu++;
				}
			}
		}
		...
		*/
		if($extensionMenu == "0") 
		{
			$smarty -> $smarty_output("../templates/$design/menu.tpl");
		}
	}
/*
    ...
    if( !in_array($module."_".$view, $early_exit) )
    {
		...
		foreach($config->extension as $extension)
		{
			...
			*/	
			if($extension->enabled == "1")
			{
				if(file_exists("./extensions/$extension->name/templates/$design/main.tpl")) 
				{
					$smarty -> $smarty_output("../extensions/$extension->name/templates/$design/main.tpl");
					$extensionMain++;
				}
			}
		}
		...
		*/
		if($extensionMain == "0") 
		{
			$smarty -> $smarty_output("../templates/$design/main.tpl");
		}
    }
...
*/
	...
	*/
	...
	foreach($config->extension as $extension)
	{
		...
		*/	
		if($extension->enabled == "1")
		{
			if(file_exists("./extensions/$extension->name/templates/$design/$module/$view.tpl")) 
			{
				$path = "../extensions/$extension->name/templates/$design/$module/";
	...
	*/
	if( ($extensionTemplates == 0) AND (file_exists("./templates/$design/$module/$view.tpl")) ) 
	{ 
				$path = "../templates/$design/$module/";
				$tplDirectory = "";
				$extensionTemplates++;
	}
	
	$smarty->assign("path",$path);
	$smarty -> $smarty_output("../".$tplDirectory."templates/$design/$module/$view.tpl");
	...
	if( !in_array($module."_".$view, $early_exit) )
	{
		...
		foreach($config->extension as $extension)
		{
			...
			*/	
			if($extension->enabled == "1")
			{
				if(file_exists("./extensions/$extension->name/templates/$design/footer.tpl")) 
				{
					$smarty -> $smarty_output("../extensions/$extension->name/templates/$design/footer.tpl");
					$extensionFooter++;
				}
			}
		}
		...
		*/
		...
		{
			$smarty -> $smarty_output("../templates/$design/footer.tpl");
		}
