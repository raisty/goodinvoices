...
$LANG['faqs_what'] = "Vad är GoodInvoices?";//1
$LANG['fax'] = "Fax";//1
...
$LANG['help_backup_database'] = "För att säkerhetskopieringen skall fungera måste webbserver användaren (förhopningsvis kör du Apache) ha läs/skriv rättigheter till database_backups katalogen i GoodInvoices mappen.<br /><br />Och om du är extra paranoid (som jag :) ) om din data så rekommenderar jag att använda phpMyAdmin. Detta säkerhetskopierings skript borde fungera som det skall, men om du kräver 'enterprise grade' säkerhetskopierings pålitlighet så är phpMyAdmin ett bra val.<br /><br />Obs: Om du använder GoodInvoices i demo miljön på SourceForge, så fungerar inte säkerhetskopieringen p.g.a. hur de har satt upp sina servrar.";//1
$LANG['help_backup_database_fwrite'] = "<b>Fick du fwrite() felmeddelanden?</b><br />Om du fick fwrite() felmeddelanden när du försökte säkerhetkopiera din GoodInvoices databas betyder detta att webbserverns användare (förhoppningsvis kör du Apache) inte har läs/skriv rättigheter till tmp/database_backups katalogen i GoodInvoices mappen.<br /><br />Vänligen ändra rättigheterna på denna katalog och försök köra säkerhetskopieringen igen. För att ändra rättigheterna för tmp/database_backups katalogen i Unix/Linux/OSX cd:a dig till GoodInvoices mappen (<i>cd /var/www/html/GoodInvoices</i>) och sen kör chmod kommandot för att ge webbserver användaren läs/skriv rättigheter (<i>chmod -Rv 777 tmp/database_backups</i>)";//1
$LANG['help_blog'] = "GoodInvoices Blogg";//1
...
$LANG['help_database_patches'] = "<b>Databas patchar behöver tillämpas</b><br />Det finns databas patchar som behöver tillämpas. Vänligen välj Databas Uppgraderings Hantering' från Inställningar menyn och följ instruktionerna.<br /><br />'Databas Uppgraderings Hanteringen' är hur GoodInvoices behandlar modifikationer i strukturen för GoodInvoices databasen. Med varje ny release kan det finnas 'Databas Patchar' som måste tillämpas. Databas Uppgraderings Hanteringen ser efter dessa Databas Patchar.<br /><br />Databas patchar är individuella modifikationer i GoodInvoices databasen. Med en ny release kan det finnas flera patchar som måste tillämpas.";//1
...
$LANG['help_insert_biller_text'] = "För att inte välja någon logo välj '_default_blank_logo.png' från listan.<br /><br />För att lägga till ytterligare logon till GoodInvoices, kopiera logo filen till logo mappen i GoodInvoices mappen.";//1
...
$LANG['help_inv_pref_what_the'] = "Faktura Mallar låter dig ange texten i fakturan. Du kan ha hur många olika 'Faktura Mallar' angivna i GoodInvoices som du vill, men du kan endast välja 1 'Faktura Mall' per faktura.<br /><br />T.ex. Om du ville ha rubriken för fakturan att säga 'Moes Tavern - Faktura' istället för standard 'Faktura', så kan du redigera 'Faktura rubrik' fältet i den relevanta Faktura Mallen för att åstadkomma detta.";//1
$LANG['help_invoice_create'] = "Att skapa fakturor är lätt. När en fodringsägare och kund har lagts till i GoodInvoices behöver du bara välja en faktura mall, fylla i detaljerna och klicka på 'Spara Faktura'.";//1
$LANG['help_invoice_custom_fields'] = "Behöver du fler fält i faktura vyn? Vill du ha dina egna fält så som 'Inköpsordning', 'Projekt Namn' osv..<br /><br />GoodInvoices låter dig lägga till vilka fält du vill till fakturorna. Dessa kallas 'egendefinierade fält', för att redigera eller sätta upp dina egna fält välj Egendefinierade Fält i Inställningar menyn.";//1
$LANG['help_invoice_types'] = "I GoodInvoices finns det 2 typer av fakturor tillgängliga<br /><br />
...
";//1
$LANG['help_logging'] = "För att logga handlingar som gör i GoodInvoices aktivera denna inställning. Detta skapar en logg i databasen på vad som gjorts.<br /><br />Obs: För tillfället är det ända sättet att se loggen att logga in i databasen. Vi kommer snart lägga till en snygg logg visare i GoodInvoices.";//1
...
$LANG['help_mysql4'] = "Eftersom du använder MySQL 4 eller äldre som din databas server har vissa funktioner i GoodInvoices inaktiverats. Några SQL-satser i GoodInvoices drar nytta av de nya funktionerna i MySQL 5, så saker som snabbrapporter här i Panelen, några skuldrapporter och en del andra funktioner har inaktiverats.";//1
...
$LANG['help_reports_xsl'] = "<b>Rapportera fel</b><br />Om du fick ett 'OOOOPS, THERE'S AN ERROR HERE.' felmeddelande när du försökte köra en rapport i GoodInvoices betyder detta att din version av PHP inte har de nödvändiga tilläggen installerade (eller aktiverade).<br /><br />Om du kör en Windows server och använder WAMP5 vänligen hänvisa till sidan på GoodInvoices wiki för information om hur man löser detta http://GoodInvoices.org/wiki/doku.php?id=how_to_i_get_reports_working_in_windows_wamp5<br /><br />Om du kör Unix/Linux och PHP5 kontrollera att du har xsl tillägget installerat och aktiverat i php.ini. I Ubuntu GNU/Linux vänligen installera php-xsl paketet för PHP5<br /><br />Om du använder PHP4 vänligen kontrollera att PHP har Sablotron support '--enable-xslt'<br /><br />Obs: Om du använder GoodInvoices i demo miljön på SourceForge så fungerar inte rapporterna p.g.a. hur de har satt upp sina servrar.";//1
...
$LANG['help_simple_invoices'] = "GoodInvoices är ett simpelt faktureringssystem designat med enkelhet och funktionalitet i tanken. Det tillgodoser behoven för små organisationer och hemma användare.<br /><br />För mera information vänligen hänvisa till GoodInvoices webbsida: <a href='http://www.GoodInvoices.org' target='_blank'><b>http://www.GoodInvoices.org</b></a>";//1
...
$LANG['help_text'] = "<b>Varning</b><br /><br />Vänligen säkerhetskopiera din GoodInvoices databas innan du kör databas uppdateringen, ifall om något dåligt skulle hända.<br /><br />För att säkerhetskopiera databasen, välj 'Säkerhetskopiera Databas' i Inställningar menyn, eller använd phpMyAdmin (om du har detta installerat) för att säkerhetskopiera databasen.";//1
$LANG['help_user_role'] = "Det finns 3 roller tillgängliga<br /><br />Administrator:<br />som har tillgång till allt i GoodInvoices<br /><br />User:<br />som har läs/skriv rättigheter till allt i GoodInvoices, men inte tillgång till Inställningar menyn<br /><br />Viewer:<br />som endast har läs rättigheter";//1
...
$LANG['prepare_simple_invoices'] = "Förbered GoodInvoices för användning";//1
$LANG['Price'] = "Pris";//1
...
$LANG['thank_you'] = "Tack för att du valt GoodInvoices!";//1
...
$LANG['upgrading_simple_invoices'] = "Uppgradera GoodInvoices";//1
$LANG['user_add'] = "Lägg till Användare";//1
$LANG['users'] = "Användare";//1
$LANG['using_simple_invoices'] = "använder GoodInvoices";//1
$LANG['value'] = "Värde";//1
$LANG['view'] = "Visa";//1
