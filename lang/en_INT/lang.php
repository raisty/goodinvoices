...
$LANG['backup_done'] = "Your database has now been backed up to the file %s, you can now continue using GoodInvoices as normal."; //1
$LANG['backup_howto'] = "To make a backup of your GoodInvoices database click the below link"; //1
...
$LANG['credit_card_number_encrypted'] = "The credit card number has been encrypted and is not displayed in GoodInvoices"; //1
...
$LANG['end_date'] = "End date (YYYY-MM-DD)"; //1
$LANG['end_date_short'] = "End date"; //1
$LANG['eway'] = "Eway"; //1
...
$LANG['faqs_what'] ="What is GoodInvoices?"; //1
$LANG['fax'] = "Fax"; //1
...
$LANG['help_backup_database'] = "For the backup to work the webserver user(hopefully your running Apache) must have read/write permissions to the database_backups directory in the GoodInvoices folder<br /><br />Also if you are extra paranoid (like me :) ) about your data I recommend using phpMyAdmin.  This backup script should work fine but if require 'enterprise grade' backup reliability phpMyAdmin rocks.<br /><br />Note: If you are using GoodInvoices in the demo environment on SourceForge, backups won't work due to setup of their servers."; //1
...
$LANG['help_blog'] = "GoodInvoices Blog"; //1
...
$LANG['help_insert_biller_text'] = "To select no logo please select '_default_blank_logo.png' from the list.<br /><br />To add additional logos into GoodInvoices, copy the logo file into the logo directory in the GoodInvoices folder."; //1
...
$LANG['help_inv_pref_locale'] = "Locale"; //1//0 TODO
...
$LANG['help_invoice_create'] = "Creating invoices is easy.  Once a biller and customer have been entered into GoodInvoices all you need to do is select an invoice type from the 'Invoice +' menu, fill in the details and click 'Save Invoice'."; //1
...
$LANG['help_invoice_types'] = "In GoodInvoices there are 2 types of invoices available<br /><br />
...
"; //1
$LANG['help_logging'] = "To log actions performed in GoodInvoices enable this option. This creates a log in the database of what actions were performed.<br /><br />Note: At the moment the only way to view the log is in the database, soon we'll incorparte a nice log viewer into GoodInvoices."; //1
...
$LANG['help_mysql4'] = "As you are using MySQL 4 or below as your database server some features of GoodInvoices have been disabled. Some sql queries in GoodInvoices have taken advantage of new features in MySQL 5, so things like the quick reports here on the start page, some debtors reports and a few other features of GoodInvoices have been disabled."; //1
...
$LANG['help_reports_xsl'] = "<b>Report errors</b><br />If you received a 'OOOOPS, THERE'S AN ERROR HERE.' error when you attempted to run a report in GoodInvoices this means that your version of PHP doesn't have the correct extentions installed(or enabled).<br /><br />If your running a Windows server and using WAMP5 please refer to the page on the GoodInvoices wiki for information on how to fix this http://GoodInvoices.org/wiki/doku.php?id=how_to_i_get_reports_working_in_windows_wamp5<br /><br />If your running Unix/Linux and PHP5 please make sure you have the xsl extension installed and enabled in your php.ini. On Ubuntu GNU/Linux please install the php-xsl package for PHP5 <br /><br />If your using PHP4 please make sure that your PHP has Sablotron support '--enable-xslt'<br /><br />Note: If you are using GoodInvoices in the demo environment on SourceForge reports won't work due to setup of their servers."; //1
...
$LANG['help_text'] = "<b>Warning</b><br /><br />Please backup your GoodInvoices database before running the database update, just incase anything bad happens.<br /><br />To backup the database, select 'Backup Database' from the Options menu, or use phpMyAdmin(if you have this installed) to back up the database."; //1
$LANG['help_user_role'] = "There are 3 roles available <br /><br />Administrator:<br />which has access to all of GoodInvoices<br /><br />User:<br />which has read/write acess to all of GoodInvoices but with no access to the Settings menu <br /><br />Viewer:<br />which has read-only version of User."; //1
...
$LANG['help_numbering'] = "This numbering start for new formulars!"; //1
...
$LANG['manage_tax_rates'] = "Rates/Tax"; //1
...
$LANG['prepare_simple_invoices'] = "Prepare GoodInvoices for use"; //1
...
$LANG['simple_invoices_powered_by'] = "Powered by GoodInvoices"; //1
...
$LANG['thank_you'] = "Thank you for choosing GoodInvoices!"; //1
...
$LANG['upgrading_simple_invoices'] = "Upgrading GoodInvoices"; //1
$LANG['user_add'] = "Add User"; //1
$LANG['users'] = "Users"; //1
$LANG['using_simple_invoices'] = "Using GoodInvoices"; //1
$LANG['value'] = "Value"; //1
$LANG['view'] = "View"; //1
...
$LANG['zip'] = "Zip code"; //1
$LANG['January'] = "January"; //1
$LANG['February'] = "February"; //1
$LANG['March'] = "March"; //1
$LANG['April'] = "April"; //1
$LANG['May'] = "May"; //1
$LANG['Juny'] = "Juny"; //1
...
$LANG['October'] = "October"; //1
$LANG['November'] = "November"; //1
$LANG['December'] = "December"; //1
$LANG['company_name'] = "Company name"; //1
$LANG['sum_total'] = "Amount total"; //1
$LANG['expenses'] = "Expenses"; //1
$LANG['forgot_password'] = "Do you forgot password?"; //1
$LANG['send_to_mail'] = "Send to e-mail"; //1
$LANG['bad_login'] = "Sorry, wrong e-mail / password"; //1
$LANG['no_logindata'] = "e-mail and password required"; //1
$LANG['no_forgotemail'] = "E-mail isn't valid!"; //1
$LANG['captchafail'] = "Captcha isn't valid!"; //1
$LANG['forgotsended'] = "The forgotten password has been sended to e-mail!<br />Check your inbox or spam folder.<br />Loading login page, please wait..."; //1
$LANG['forgotmail_subject'] = "Forgotten password"; //1
$LANG['forgotmail_intro_1'] = "Someone has requested password reset for your account.<br /><hr /><br />IP address: "; //1
$LANG['forgotmail_intro_2'] = "<br />Host: "; //1
$LANG['forgotmail_intro_3'] = "<br /><hr /><br />Your new generated password is: <b>"; //1
$LANG['forgotmail_intro_4'] = "</b><br /><br />Is it recommended to change this password after login."; //1
$LANG['forgotmail_intro_5'] = "Click there for login page."; //1
$LANG['forgotmismatch'] = "E-mail doesn't exist in system!"; //1
$LANG['forgotcanotsaved'] = "New password cannot be saved, please contact admin!"; //1
$LANG['forgotcannotemailed'] = "New password cannot be sended to e-mail, please contact admin!"; //1
$LANG['forgot_info'] = "If you have forgot your password,<br />you can genereate another one.<br />The new password will be sent to your e-mail.<br />Is it recommended change the password<br />after login."; //1
$LANG['dept_summary'] = "Summary"; //1
$LANG['dept_payed'] = "Payed"; //1
$LANG['dept_owing'] = "Owing"; //1
$LANG['dept_aging'] = "Aging in days"; //1
$LANG["startdate"] = "Start date"; //1
$LANG["enddate"] = "End date"; //1
$LANG["show"] = "Show"; //1
$LANG["inv_created"] = "Invoices created"; //1
$LANG["inv_modified"] = "Invoices modified"; //1
$LANG["inv_payproc"] = "Payment process"; //1
$LANG["for"] = "for"; //1
$LANG['phone_short'] = "Ph."; //1
$LANG['mobile_short'] = "Mob."; //1
$LANG['nonpayer_vat'] = "VAT non-payer"; //1
$LANG['date_of_creation'] = "Generated"; //1
$LANG['date_of_delivery'] = "Delivered"; //1
$LANG['date_of_maturity'] = "Valid to"; //1
$LANG['variable_symbol'] = "Variable symbol"; //1
$LANG['type_of_payment'] = "Payment type"; //1
...
$LANG['note'] = "Note"; //1
$LANG['who_create'] = "Issued"; //1
$LANG['who_take'] = "Assumed"; //1
$LANG['total'] = "Total"; //1
$LANG['paid'] = "Paid"; //1
$LANG['owing'] = "Owing"; //1
$LANG['document_nomb'] = "document number"; //1
$LANG['from_payer'] = "Recived from"; //1
$LANG['isum_netto'] = "Amount netto"; //1
$LANG['isum_vat'] = "VAT"; //1
$LANG['isum_brutto'] = "Amount summary"; //1
$LANG['isum_curren'] = "Currency"; //1
$LANG['isum_wording'] = "Amount (wording)"; //1
$LANG['isum_teller'] = "Casier signature"; //1
$LANG['isum_recip'] = "Recipient signature"; //1
$LANG['inv_prodsel'] = "You must select an product"; //1
$LANG['constant_symbol'] = "Constant symbol:"; //1
$LANG['bank'] = "Bank"; //1
$LANG['supplier'] = "Supplier"; //1
$LANG['profit_txt_1'] = "Profit per Invoice based on average product cost summary for the period "; //1
$LANG['profit_txt_2'] = " to "; //1
$LANG['inv_tocust'] = " to Customer as PDF"; //1
$LANG['reset'] = "Reset"; //1
$LANG['inv_em1'] = " send to you '"; //1
$LANG['inv_em2'] = "', which is situated in attachment as PDF file."; //1
$LANG['inv_delete'] = "Deleting invoices"; //1
$LANG['paymentproc_name'] = "Payment"; //1
$LANG['date_of_print'] = "Date of print"; //1
$LANG['fast_login'] = "You're very fast, please login slower."; //1
$LANG['invoice_numbering'] = "Formulars numbering"; //1
$LANG['numbering'] = "numbering"; //1
$LANG['numbering_'] = "No default value"; //1
$LANG['numbering_0'] = "1,2,3,...x"; //1
$LANG['numbering_1'] = "110001,110002,...x 120001,120002,...y"; //1
$LANG['exp_statement'] = "statement"; //1
$LANG['exp_payment'] = "payment"; //1
$LANG['suppliers_numbering'] = "Suppliers id signing"; //1
$LANG['suppliers_numbering_'] = "No default value"; //1
$LANG['suppliers_numbering_0'] = "All suppliers together (no ID)"; //1
$LANG['suppliers_numbering_1'] = "Suppliers separately (ID before form ID)"; //1
$LANG['delete_cron_success'] = "Cron record was deleted."; //1
$LANG['delete_cron_failure'] = "Cron record cannot be deleted!"; //1
?>
