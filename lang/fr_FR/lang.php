...
$LANG['backup_done'] = "Votre base a &eacute;t&eacute; sauvegard&eacute;e jusqu'au fichier %s, vous pouvez maintenant continuer &agrave; utiliser GoodInvoices normalement.";//1
$LANG['backup_howto'] = "Pour sauvegarder  votre base de donn&eacute;ees GoodInvoices database cliquer ci-dessous";//1
...
$LANG['faqs_need'] ="Pr&eacute;-requis pour utiliser GoodInvoices";//1
$LANG['faqs_type'] ="Quels sont les diff&eacute;rents types de factures&nbsp;?";//1
$LANG['faqs_what'] ="Qu'est-ce que GoodInvoices&nbsp;?";//1
$LANG['fax'] = "Fax";//1
...
$LANG['prepare_simple_invoices'] = "Param&eacute;trer GoodInvoices";//1
$LANG['Price'] = "Total";//1
...
$LANG['thank_you'] = "Merci d'avoir choisi GoodInvoices !";//1
...
$LANG['upgrading_simple_invoices'] = "Mettre &agrave; jour GoodInvoices";//1
$LANG['user_add'] = "Ajouter un Utilisateur";//1
$LANG['users'] = "Utilisateurs";//1
$LANG['using_simple_invoices'] = "Utiliser GoodInvoices";//1
$LANG['view'] = "Voir";//1
